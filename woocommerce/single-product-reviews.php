...
<div id="reviews" class="woocommerce-Reviews">
	<div id="comments">
		...
		<?php else: ?>
			...
			<p class="woocommerce-noreviews"><?php esc_html_e( 'There are no reviews yet.', 'studiare' ); ?></p>
                ...
                <div class="review_form" id="review_form">
                    <?php
                        ...
                        if ( get_option( 'woocommerce_enable_review_rating' ) === 'yes' ) {
                            $comment_form['comment_field'] = '<div class="comment-form-rating"><label for="rating">' . esc_html__( 'Your rating', 'studiare' ) . '</label><select name="rating" id="rating" aria-required="true" required>
                                <option value="">' . esc_html__( 'Rate&hellip;', 'studiare' ) . '</option>
