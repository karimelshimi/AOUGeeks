...
<?php endif; ?>
	...
	<div class="box-holder">
		<h2 class="login-title"><?php esc_html_e( 'Login', 'studiare' ); ?></h2>
		...
		<form class="woocommerce-form woocommerce-form-login login" method="post">
			...
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="username"><?php esc_html_e( 'Username or email address', 'studiare' ); ?>&nbsp;<span class="required">*</span></label>
				<input type="text" class="woocommerce-Input woocommerce-Input--text input-text" name="username" id="username" autocomplete="username" value="<?php echo ( ! empty( $_POST['username'] ) ) ? esc_attr( wp_unslash( $_POST['username'] ) ) : ''; ?>" /><?php // @codingStandardsIgnoreLine ?>
			</p>
			<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
				<label for="password"><?php esc_html_e( 'Password', 'studiare' ); ?>&nbsp;<span class="required">*</span></label>
...
<?php if ( get_option( 'woocommerce_enable_myaccount_registration' ) === 'yes' ) : ?>
	...
	<div class="u-column2 col-2">
		...
		<div class="box-holder">
			<h2 class="login-title"><?php esc_html_e( 'Register', 'studiare' ); ?></h2>
			...
			<form method="post" class="woocommerce-form woocommerce-form-register register">
				...
				<?php if ( 'no' === get_option( 'woocommerce_registration_generate_username' ) ) : ?>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="reg_username"><?php esc_html_e( 'Username', 'studiare' ); ?>&nbsp;<span class="required">*</span></label>
				...
				<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
					<label for="reg_email"><?php esc_html_e( 'Email address', 'studiare' ); ?>&nbsp;<span class="required">*</span></label>
				...
				<?php if ( 'no' === get_option( 'woocommerce_registration_generate_password' ) ) : ?>
					...
					<p class="woocommerce-form-row woocommerce-form-row--wide form-row form-row-wide">
						<label for="reg_password"><?php esc_html_e( 'Password', 'studiare' ); ?>&nbsp;<span class="required">*</span></label>
